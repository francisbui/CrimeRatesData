...
public class USCrimeDataSample {
    ...
    // Test Data retrieved from Crime.csv

    public String[][] getArrayData() { //test to see if data from Crime.csv is correct
        return crime2DArray;
    }

    public void printTest() { //test to see if "displaying" columns in the Crime.csv is correct

        String output = "";
        for (int i = 0; i <= crime2DArray[i].length; i++) {
            for (int j = 0; j <= crime2DArray[j].length; j++) {
                output = crime2DArray[i][1]; // put [i] in the first bracket and number in the second [] to find values in the column; put a [] number in the first and [i] in the second to find row
            }
            System.out.println(output); //this is not an array
        }
    }

    public void searchTest() { //test to see if "searching" columns in the Crime.csv is correct
        String[] addToArray = new String[21];
        String output = "";
        for (int i = 0; i <= crime2DArray[i].length; i++) {
            for (int j = 0; j <= crime2DArray[j].length; j++) {
                addToArray[i] = crime2DArray[i][4]; // put [i] in the first bracket and number in the second [] to find values in the column; put a [] number in the first and [i] in the second to find row

                output = crime2DArray[i][4]; // put [i] in the first bracket and number in the second [] to find values in the column; put a [] number in the first and [i] in the second to find row
            }
            System.out.println(output); //this is not an array; it prints out each line looping through the column
        }
        System.out.println(Arrays.toString(addToArray)); //this is not an array
        Arrays.sort(addToArray);
        System.out.println(Arrays.toString(addToArray)); //this is not an array
        System.out.println(addToArray[0]);
        for (int i = 0; i <= crime2DArray[i].length; i++) {
            for (int j = 0; j <= crime2DArray[j].length; j++) {
                if (crime2DArray[i][4].equalsIgnoreCase(addToArray[0])) //locates the value in the 2D array
                    minMurder = crime2DArray[i][0]; // locates and assigns the value to the corresponding year
            }
        }
        System.out.println(minMurder);
    }
    ...
    public String getMaxMurder() {
        ...
        for (int i = 0; i <= crime2DArray[i].length; i++) {
            for (int j = 0; j <= crime2DArray[j].length; j++) {
                ...
                output = crime2DArray[i][5]; // put [i] in the first bracket and number in the second [] to find values in the column; put a [] number in the first and [i] in the second to find row
            }
            System.out.println(output); //this is not an array; it prints out each line looping through the column
        }
        System.out.println(Arrays.toString(addToArray)); //this is not an array
        Arrays.sort(addToArray);
        System.out.println(Arrays.toString(addToArray)); //this is not an array
        System.out.println(addToArray[19]);
        for (int i = 0; i <= crime2DArray[i].length; i++) {
            for (int j = 0; j <= crime2DArray[j].length; j++) {
    ...
    public String getMaxRobbery() {
        ...
        for (int i = 0; i <= crime2DArray[i].length; i++) {
            for (int j = 0; j <= crime2DArray[j].length; j++) {
                ...
                output = crime2DArray[i][9]; // put [i] in the first bracket and number in the second [] to find values in the column; put a [] number in the first and [i] in the second to find row
            }
            System.out.println(output); //this is not an array; it prints out each line looping through the column
        }
        System.out.println(Arrays.toString(addToArray)); //this is not an array
